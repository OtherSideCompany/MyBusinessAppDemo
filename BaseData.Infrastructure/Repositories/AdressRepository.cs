...
{
    public class AdressRepository : Repository<Domain.DomainObjects.Adress, Adress>
    {
        #region Fields
        ...
        public AdressRepository(RepositoryDependencies repositoryDependencies) : base(repositoryDependencies)
        {
